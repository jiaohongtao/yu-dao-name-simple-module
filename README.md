...
* 演示地址【Vue3 + element-plus】：<http://dashboard-vue3.sdps.iocoder.cn>
* 演示地址【Vue3 + vben(ant-design-vue)】：<http://dashboard-vben.sdps.iocoder.cn>
* 演示地址【Vue2 + element-ui】：<http://dashboard.sdps.iocoder.cn>
...
![架构图](https://static.iocoder.cn/sdps-cloud-architecture.png?imageView2/2/format/webp)

* 管理后台的电脑端：Vue3 提供 [element-plus](https://gitee.com/sdpscode/sdps-ui-admin-vue3)、[vben(ant-design-vue)](https://gitee.com/sdpscode/sdps-ui-admin-vben) 两个版本，Vue2 提供 [element-ui](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/sdps-ui-admin) 版本
...
![架构演进](https://static.iocoder.cn/sdps-roadmap.png?imageView2/2/format/webp)
...
| [sdps-cloud](https://gitee.com/zhijiantianya/sdps-cloud)      | [![Gitee star](https://gitee.com/zhijiantianya/sdps-cloud/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/sdps-cloud) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/sdps-cloud.svg?style=social&label=Stars)](https://github.com/YunaiV/sdps-cloud)               | 基于 Spring Cloud 微服务架构       |
| [Spring-Boot-Labs](https://gitee.com/sdpscode/SpringBoot-Labs) | [![Gitee star](https://gitee.com/sdpscode/SpringBoot-Labs/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/sdps-cloud) [![GitHub stars](https://img.shields.io/github/stars/sdpscode/SpringBoot-Labs.svg?style=social&label=Stars)](https://github.com/sdpscode/SpringBoot-Labs) | 系统学习 Spring Boot & Cloud 专栏 |

### 前端项目

| 项目                                                                                                       | Star                                                                                                                                                                                                                                                                                                                                                           | 简介                              |
|----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| [sdps-ui-admin-vue3](https://gitee.com/sdpscode/sdps-ui-admin-vue3)                                   | [![Gitee star](https://gitee.com/sdpscode/sdps-ui-admin-vue3/badge/star.svg?theme=white)](https://gitee.com/sdpscode/sdps-ui-admin-vue3) [![GitHub stars](https://img.shields.io/github/stars/sdpscode/sdps-ui-admin-vue3.svg?style=social&label=Stars)](https://github.com/sdpscode/sdps-ui-admin-vue3)                                               | 基于 Vue3 + element-plus 实现的管理后台  |
| [sdps-ui-admin-vben](https://gitee.com/sdpscode/sdps-ui-admin-vben)                                   | [![Gitee star](https://gitee.com/sdpscode/sdps-ui-admin-vben/badge/star.svg?theme=white)](https://gitee.com/sdpscode/sdps-ui-admin-vben) [![GitHub stars](https://img.shields.io/github/stars/sdpscode/sdps-ui-admin-vben.svg?style=social&label=Stars)](https://github.com/sdpscode/sdps-ui-admin-vben)                                               | 基于 Vue3 + vben(ant-design-vue) 实现的管理后台 |
| [sdps-ui-admin](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/sdps-ui-admin)               | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/sdps-ui-admin) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/sdps-ui-admin)               | 基于 Vue2 + element-ui 实现的管理后台    |
| [sdps-ui-admin-uniapp](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/sdps-ui-admin-uniapp) | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/sdps-ui-admin-uniapp) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/sdps-ui-admin-uniapp) | 基于 uni-app + uni-ui 实现的管理后台的小程序 |
| [sdps-ui-go-view](https://gitee.com/sdpscode/sdps-ui-go-view)                                         | [![Gitee star](https://gitee.com/sdpscode/sdps-ui-go-view/badge/star.svg?theme=white)](https://gitee.com/sdpscode/sdps-ui-go-view) [![GitHub stars](https://img.shields.io/github/stars/sdpscode/sdps-ui-go-view.svg?style=social&label=Stars)](https://github.com/sdpscode/sdps-ui-go-view)                                                           | 基于 Vue3 + naive-ui 实现的大屏报表      |
| [sdps-ui-app](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/sdps-ui-app)                   | [![Gitee star](https://gitee.com/zhijiantianya/ruoyi-vue-pro/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master/sdps-ui-app) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/ruoyi-vue-pro.svg?style=social&label=Stars)](https://github.com/YunaiV/ruoyi-vue-pro/tree/master/sdps-ui-app)                   | 基于 uni-app + uview 实现的用户 App    |
...
| 项目                                                                       | 说明                 |
|--------------------------------------------------------------------------|--------------------|
| `sdps-dependencies`                                                     | Maven 依赖版本管理       |
| `sdps-framework`                                                        | Java 框架拓展          |
| `sdps-server`                                                           | 管理后台 + 用户 APP 的服务端 |
| `sdps-module-system`                                                    | 系统功能的 Module 模块    |
| `sdps-module-member`                                                    | 会员中心的 Module 模块    |
| `sdps-module-infra`                                                     | 基础设施的 Module 模块    |
| `sdps-module-bpm`                                                       | 工作流程的 Module 模块    |
| `sdps-module-pay`                                                       | 支付系统的 Module 模块    |
| `sdps-module-mall`                                                      | 商城系统的 Module 模块    |
| `sdps-module-mp`                                                        | 微信公众号的 Module 模块   |
| `sdps-module-report`                                                    | 大屏报表 Module 模块     |
...
| [Nacos](https://github.com/alibaba/nacos)                                                   | 配置中心 & 注册中心      | 2.0.4       | [文档](https://www.iocoder.cn/categories/Nacos/?sdps)                |
| [RocketMQ](https://github.com/apache/rocketmq)                                              | 消息队列             | 4.9.4       | [文档](https://www.iocoder.cn/categories/RocketMQ/?sdps)             |
| [Sentinel](https://github.com/alibaba/sentinel)                                             | 服务保障             | 1.8.6       | [文档](https://www.iocoder.cn/categories/Sentinel/?sdps)             |
| [XXL Job](https://github.com/xuxueli/xxl-job)                                               | 定时任务             | 2.3.1       | [文档](https://www.iocoder.cn/XXL-JOB/good-collection/?sdps)         |
| [Spring Cloud Gateway](https://github.com/spring-cloud/spring-cloud-gateway)                | 服务网关             | 3.4.1       | [文档](https://www.iocoder.cn/categories/Spring-Cloud-Gateway/?sdps) |
| [Seata](https://github.com/seata/seata)                                                     | 分布式事务            | 1.6.1       | [文档](https://www.iocoder.cn/categories/Seata/?sdps)                |
| [MySQL](https://www.mysql.com/cn/)                                                          | 数据库服务器           | 5.7 / 8.0+  |                                                                     |
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件    | 1.2.16      | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?sdps)      |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包    | 3.5.3.1     | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?sdps)              |
| [Dynamic Datasource](https://dynamic-datasource.com/)                                       | 动态数据源            | 3.6.0       | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?sdps)      |
| [Redis](https://redis.io/)                                                                  | key-value 数据库    | 5.0 / 6.0   |                                                                     |
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端        | 3.18.0      | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?sdps)                |
| [Spring MVC](https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc) | MVC 框架           | 5.3.24      | [文档](http://www.iocoder.cn/SpringMVC/MVC/?sdps)                    |
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架      | 5.7.5       | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?sdps)      |
| [Hibernate Validator](https://github.com/hibernate/hibernate-validator)                     | 参数校验组件           | 6.2.5       | [文档](http://www.iocoder.cn/Spring-Boot/Validation/?sdps)           |
| [Flowable](https://github.com/flowable/flowable-engine)                                     | 工作流引擎            | 6.7.2       | [文档](https://doc.iocoder.cn/bpm/)                                   |
| [Knife4j](https://gitee.com/xiaoym/knife4j)                                                 | Swagger 增强 UI 实现 | 4.0.0       | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?sdps)              |
| [SkyWalking](https://skywalking.apache.org/)                                                | 分布式应用追踪系统        | 8.12.0      | [文档](http://www.iocoder.cn/Spring-Boot/SkyWalking/?sdps)           |
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台 | 2.7.10      | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?sdps)                |
| [Jackson](https://github.com/FasterXML/jackson)                                             | JSON 工具库         | 2.13.3      |                                                                     |
| [MapStruct](https://mapstruct.org/)                                                         | Java Bean 转换     | 1.5.5.Final | [文档](http://www.iocoder.cn/Spring-Boot/MapStruct/?sdps)            |
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码    | 1.18.26     | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?sdps)               |
