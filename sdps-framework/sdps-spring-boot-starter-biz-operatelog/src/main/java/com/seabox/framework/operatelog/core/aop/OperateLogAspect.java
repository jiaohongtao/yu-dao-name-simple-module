package com.seabox.framework.operatelog.core.aop;
...
import com.seabox.framework.operatelog.core.service.OperateLog;
import com.seabox.framework.operatelog.core.service.OperateLogFrameworkService;
import com.seabox.framework.web.core.util.WebFrameworkUtils;
...
import static com.seabox.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.seabox.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.seabox.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.seabox.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.seabox.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.seabox.framework.operatelog.core.annotations.OperateLog operateLog,
