package com.seabox.gateway.util;

import cn.hutool.core.map.MapUtil;
import com.seabox.framework.common.util.json.JsonUtils;
import com.seabox.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from sdps-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * @author 芋道源码
 */
