...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.seaboxdata";
    private static final String ARTIFACT_ID = "sdps";
    private static final String PACKAGE_NAME = "com.seabox";
    private static final String TITLE = "海盒大数据平台系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.seaboxdata";
        String artifactIdNew = "sdps";
        String packageNameNew = "com.seabox";
        String titleNew = "海盒大数据平台系统";
        String projectBaseDirNew = "D:\\DFJX\\Github\\yu-dao-name-simple-module";
