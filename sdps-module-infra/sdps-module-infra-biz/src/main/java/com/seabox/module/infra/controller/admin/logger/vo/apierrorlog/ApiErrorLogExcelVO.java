package com.seabox.module.infra.controller.admin.logger.vo.apierrorlog;

import com.seabox.framework.excel.core.annotations.DictFormat;
import com.seabox.framework.excel.core.convert.DictConvert;
import com.seabox.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(com.seabox.module.system.enums.DictTypeConstants.USER_TYPE)
