package com.seabox.module.infra.service.codegen.inner;
...
import com.seabox.framework.common.exception.util.ServiceExceptionUtil;
...
import com.seabox.framework.common.util.date.LocalDateTimeUtils;
import com.seabox.framework.common.util.object.ObjectUtils;
import com.seabox.framework.excel.core.annotations.DictFormat;
import com.seabox.framework.excel.core.convert.DictConvert;
import com.seabox.framework.excel.core.util.ExcelUtils;
...
import com.seabox.framework.operatelog.core.enums.OperateTypeEnum;
...
import com.seabox.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "sdps-module-${table.moduleName}/" + // 顶级模块
                "sdps-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "sdps-module-${table.moduleName}/" + // 顶级模块
                "sdps-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "sdps-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "sdps-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
