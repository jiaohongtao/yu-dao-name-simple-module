...
import com.seabox.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.seabox.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.seabox.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.seabox.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("sdps-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("sdps-test");
