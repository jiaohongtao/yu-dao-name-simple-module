package com.seabox.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.seabox.framework.common.enums.CommonStatusEnum;
import com.seabox.framework.common.exception.ServiceException;
import com.seabox.framework.common.pojo.PageResult;
import com.seabox.framework.common.util.collection.ArrayUtils;
import com.seabox.framework.common.util.collection.CollectionUtils;
import com.seabox.framework.test.core.ut.BaseDbUnitTest;
import com.seabox.module.infra.api.file.FileApi;
import com.seabox.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.seabox.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.seabox.module.system.controller.admin.user.vo.user.*;
import com.seabox.module.system.dal.dataobject.dept.DeptDO;
import com.seabox.module.system.dal.dataobject.dept.PostDO;
import com.seabox.module.system.dal.dataobject.dept.UserPostDO;
import com.seabox.module.system.dal.dataobject.tenant.TenantDO;
import com.seabox.module.system.dal.dataobject.user.AdminUserDO;
import com.seabox.module.system.dal.mysql.dept.UserPostMapper;
import com.seabox.module.system.dal.mysql.user.AdminUserMapper;
import com.seabox.module.system.enums.common.SexEnum;
import com.seabox.module.system.service.dept.DeptService;
import com.seabox.module.system.service.dept.PostService;
import com.seabox.module.system.service.permission.PermissionService;
import com.seabox.module.system.service.tenant.TenantService;
...
import static com.seabox.framework.common.util.collection.SetUtils.asSet;
import static com.seabox.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.seabox.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.seabox.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.seabox.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.seabox.framework.test.core.util.AssertUtils.assertServiceException;
import static com.seabox.framework.test.core.util.RandomUtils.*;
import static com.seabox.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("sdpsyuanma");
        ...
        assertEquals("sdpsyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("sdpsyuanma"))).thenReturn("java");
